...
/* q is search word,
 * count is search number,
 * lang is written language
 * result_type is wheather recent or not.
 * count is number for serching.
 */
$options = array('q'=>$keyword, 'lang' => 'en', 'result_type' => 'recent', 'count' => SEARCH_COUNT );
